defmodule AdventOfCode2025.Day02Test do
  ...
  describe "part1/2" do
    test "returns the expected result for the example input" do
      ...
      IO.puts("Example result: #{Day02.part1(@example_input)}")
      IO.puts("Solution: #{Day02.part1(@input)}")
    end
  end
  ...
  describe "part2/2" do
    test "returns the expected result for the example input" do
      ...
      IO.puts("Example result: #{Day02.part2(@example_input)}")
      IO.puts("Solution: #{Day02.part2(@input)}")
    end
  end
end
